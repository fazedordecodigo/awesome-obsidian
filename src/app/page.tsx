        ...
        <div className="container mx-auto px-4 text-center">
          <div className="flex flex-col items-center gap-4">
            <p className="text-sm text-muted">
              &copy; {new Date().getFullYear()} Awesome Obsidian. Desenvolvido com ❤️ por{" "}
              <a
                href="https://github.com/fazedordecodigo"
                target="_blank"
            ...
            <a
              href="https://github.com/fazedordecodigo/awesome-obsidian"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-full border border-border bg-background px-4 py-1.5 text-sm font-medium text-foreground transition-colors hover:bg-accent hover:text-accent-foreground"
            >
              <svg
                role="img"
                viewBox="0 0 24 24"
